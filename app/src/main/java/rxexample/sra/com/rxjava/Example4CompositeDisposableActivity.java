...
public class Example4CompositeDisposableActivity extends AppCompatActivity {
     ...
     */
    private static final String TAG = Example4CompositeDisposableActivity.class.getSimpleName();
